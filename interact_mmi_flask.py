...
history = []
text_history = []
print("finished preparing the chatbot")
...
def hello():
    global text_history
    text_history = []
    return render_template('chat.html', text_history=text_history) 
...
def chat():
    ...
    text_history.append("机器人：" + "".join(text))
    print("".join(text))
